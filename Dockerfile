...
RUN wget -q http://d3kbcqa49mib13.cloudfront.net/spark-1.2.0-bin-hadoop2.4.tgz
RUN tar -zxvf spark-1.2.0-bin-hadoop2.4.tgz 
RUN rm spark-1.2.0-bin-hadoop2.4.tgz
RUN mv spark-1.2.0-bin-hadoop2.4 /usr/local/spark/
